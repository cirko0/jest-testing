...
describe("DataBase test suite", () => {
  ...
  beforeEach(() => {
    ...
    // Jest stubs (used to replace real implementations with predetermined reponsees or behavior)
    // Like this we spy on the function and control it to our needs (in this case we want it to return just one id every time not random id)
  ...
  it("should return id after insert", async () => {
    // this id: "" is a dummy
    const dummyId = "";
    const actual = await sut.insert({ id: dummyId } as any);
